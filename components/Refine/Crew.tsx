                ...
                <Hidden only={['xs']}>
                  ...
                  <Switch
                    checked={
                      webstore.crew.name &&
                      results.length > 0 &&
                      webstore.crew.name.length === results.length
                        ? true
              ...
              <div className={classes.buttonWrap}>
                <PillButton
                  ...
                  style={{
                    ...
                    // webstore.crew.name.length > 0 ? '#FF4275' : '#35147A',
                    border: '0.5px solid #FF4275',
                    // webstore.crew.name.length > 0
                    //   ? '0.5px solid #FF4275'
                    //   : '0.5px solid #35147A',
                    ...
                    left: '11.5%',
                    pointerEvents: 'auto',
                    // webstore.crew.name.length > 0 ? 'auto' : 'none',
                    opacity: 1,
                    //webstore.crew.name.length > 0 ? 1 : '0.3',
                  }}
