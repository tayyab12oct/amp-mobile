...
export default function CriticsReview(props) {
    ...
    <div className={classes.root}>
      ...
      >
        ...
        container direction="row">
          ...
          <Grid container xs={12} spacing={4} className={classes.criticsBox}>
            {props.criticsReviews &&
              props.criticsReviews
                .filter((review) => review.headline !== '')
                .map((critics) => {
                  return (
                    <Grid
                      xs={12}
                        ...
                        <Box className={classes.rightBox}>
                          <CardContent className={classes.cardContent}>
                            ...
                            <Typography className={classes.channelDesc}>
                              {critics.source.summary &&
                                critics.source.summary.substring(0, 85)}{' '}
                              || {critics.headline}
                              ...
                              {/* <span>
                            Read More
