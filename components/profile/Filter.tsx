...
export default function FilterButton(props) {
  ...
  const allGenres = [
    ...
    { id: 2, value: 'Thriller', name: 'Thriller' },
    { id: 2, value: 'Musical', name: 'Musical' },
    { id: 3, value: 'Sports', name: 'Sports' },
    { id: 4, value: 'Drama', name: 'Drama' },
  ...
  const handleButtons = (value: any) => {
    ...
    const buttonIds = [...props.button];
    if (buttonIds.includes(value)) {
      buttonIds.splice(buttonIds.indexOf(value), 1);
    } else {
  ...
  const renderMobileModal = () => {
    return (
      ...
      >
        <RefineTab isOpen={modalIsOpen} setModal={setModalIsOpen} />
      </Modal>
    );
  };
          ...
          <PillButton
            ...
            endIcon={
              <RefinedItems
                count="+3"
                className={
                  refine === true ? classes.filterCount : classes.noFilter
                }
              />
            }
            style={refinePillBtn}
