...
import { Card, CardMedia, Grid, Hidden, Popover } from '@material-ui/core';
import {
...
export function MovieDescription(props) {
  ...
  const tickButton = {
    tick: 'https://images.ottplay.com/static/Group 13518.svg',
    plus: 'https://images.ottplay.com/static/Group 7583.svg',
  };
  const likeButton = {
    like: 'https://images.ottplay.com/static/Group 7044.svg',
    likeSelect: 'https://images.ottplay.com/static/Group 13511.svg',
  };
  const disLikeButton = {
    dislike: 'https://images.ottplay.com/static/Group 8470.svg',
    dislikeSelect: 'https://images.ottplay.com/static/dislikeddetail.svg',
  };
  const reviewButton = {
    review: 'https://images.ottplay.com/static/Group 8472.svg',
    reviewSelect: 'https://images.ottplay.com/static/Group 13515.svg',
  };
  const shareButton = {
    share: 'https://images.ottplay.com/static/shareIcon.svg',
    shareSelect: 'https://images.ottplay.com/static/Group 13517.svg',
  };
            ...
            >
              ...
              <Grid item xs={12} className={classes.movie_option_container}>
                <div>
                  <ImageComponent
                    src={
                      shareImage ? shareButton.share : shareButton.shareSelect
                    }
                    className={classes.movie_option}
                  ...
                  >
                    <ShareUs data={props} handleClose={() => handleClose()} />
                  </Popover>
                </div>
              </Grid>
            </Grid>
                  ...
                  <Grid item xs={12} className={classes.ctaIcons}>
                    ...
                    >
                      ...
                      >
                        <ImageComponent
                          src={
                            props.isSelected ? tickButton.plus : tickButton.tick
                          }
                          className={classes.movie_option}
                      ...
                      >
                        <ImageComponent
                          src={
                            shareImage
                              ? shareButton.share
                              : shareButton.shareSelect
                          }
                          className={classes.movie_option}
                          onMouseOver={() => setShareImage(!shareImage)}
                          onMouseOut={() => setShareImage(!shareImage)}
                          alt=""
                          onClick={() => handleMobShare()}
                        />
                      </Grid>
                    </Grid>
                  </Grid>
