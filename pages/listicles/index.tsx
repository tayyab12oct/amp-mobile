import { Footer, NavBar, PagePath, Spinner, TopHeader } from '../../components';
...
function AllListicles({ ...props }) {
  ...
  const params = {
    data: {
      content_type:
        state.contentType === 'all-news' ? 'news' : state.contentType,
...
<ImageComponent src={renderLogo()} alt="publiser_logo" />
  ...
  return (
    <div className={classes.root} id={'all-listicle-list'}>
      <div>
        <SEO>
          <meta property="og:title" content={'Top OTT Listicles'} />
