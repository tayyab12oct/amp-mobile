        ...
        >
            ...
            <div>
              <div>
                ...
                <div className={classes.about_content}>
                  {' '}
                  We are working towards making OTTplay a product that is always
                  at your fingertips. Your feedback is crucial to us to decide
                  which features to build and where we can improve. To help us
                  do our best, please share your feedback with us. You can write
                  to us at{' '}
          ...
          <div>
            <p className={classes.sourceHeader}>
              We are using the following News Publishers on the OTTplay platform
            </p>
