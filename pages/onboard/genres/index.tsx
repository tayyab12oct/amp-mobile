...
import { GenresCard, PillButton } from '../../../components';
    ...
    <Fragment>
      ...
      <div className={classes.root}>
        ...
        <Grid xs={12} container item>
          ...
          >
            <Grid item xs={8}>
              <div className={classes.header1}>Watch By Genres</div>
              <div className={classes.header2}> Based on your moods</div>
            </Grid>
            <Grid
              item
              xs={4}
        ...
        <Grid xs={12} container item className={classes.genres}>
          <Grid sm={1} lg={2} item></Grid>
          <Grid
            item
            xs={12}
          ...
          >
            ...
            <Hidden only={['sm', 'md', 'lg', 'xl']}>
              <CustomCardContent>
                <PillButton
                  text={webstore.genres.name.length > 0 ? 'Proceed' : 'Skip'}
                  endIcon={
                    <ImageComponent
